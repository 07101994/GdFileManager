...
public class InformationDialog extends AlertDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(mFileInfo.name);

        ((TextView) mView.findViewById(R.id.information_size))
                .setText(formatFileSizeString(mFileInfo.size));
        ((TextView) mView.findViewById(R.id.information_location))
                .setText(mFileInfo.path);
        ((TextView) mView.findViewById(R.id.information_modified)).setText(Utils
